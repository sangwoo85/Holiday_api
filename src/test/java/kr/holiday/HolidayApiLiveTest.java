...
class HolidayApiLiveTest {
    ...
    @Test
    void 실제_API_에서_2027년_공휴일과_대체공휴일을_가져온다() throws Exception {
        ...
        assertTrue(holidays.stream().anyMatch(h -> h.date().equals(LocalDate.of(2027, 1, 1))),
                "신정(2027-01-01) 누락");
        // 설날 연휴(2027-02-06 토 ~ 02-08 월)가 토요일과 겹쳐 지정되는 대체공휴일
